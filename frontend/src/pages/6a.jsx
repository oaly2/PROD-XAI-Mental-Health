    ...
    <div className={styles.containerS}>
      ...
      <form>
        <div className={styles.question}>
          ...
          ... würde ich mich in Zukunft stärker um die Verbesserung meiner mentalen Gesundheit kümmern
          </h2>
          <br />
        ...
        <div className={styles.question}>
          <h2 style={{fontSize: '16px', fontWeight:'bold', color: '#19b394'}} >
          ... würde ich konkrete Dinge in meinem Alltag so gestalten, dass es meine mentale Gesundheit verbessert 
          </h2>
          <br />
          {['Ich stimme voll und ganz zu', 'Ich stimme zu', 'Ich stimme eher zu', 'Ich stimme weder zu noch lehne ich ab', 'Ich stimme eher nicht zu', 'Ich stimme nicht zu', 'Ich stimme überhaupt nicht zu'].map(option => (
            <label key={option}>
        ...
        <div className={styles.question}>
          <h2 style={{fontSize: '16px', fontWeight:'bold', color: '#19b394'}} >
          ... könnte ich mir vorstellen, Unterstützungsangebote für die Verbesserung meiner mentalen Gesundheit in Anspruch zu nehmen.
          </h2>
          <br />
          {['Ich stimme voll und ganz zu', 'Ich stimme zu', 'Ich stimme eher zu', 'Ich stimme weder zu noch lehne ich ab', 'Ich stimme eher nicht zu', 'Ich stimme nicht zu', 'Ich stimme überhaupt nicht zu'].map(option => (
            <label key={option}>
        ...
        <div className={styles.question}>
          <h2 style={{fontSize: '16px', fontWeight:'bold', color: '#19b394'}} >
          ... würde ich bestimmte Verhaltensweisen so gestalten, dass sie der Verbesserung meiner mentalen Gesundheit zuträglich sind
          </h2>
          <br />
          {['Ich stimme voll und ganz zu', 'Ich stimme zu', 'Ich stimme eher zu', 'Ich stimme weder zu noch lehne ich ab', 'Ich stimme eher nicht zu', 'Ich stimme nicht zu', 'Ich stimme überhaupt nicht zu'].map(option => (
            <label key={option}>
